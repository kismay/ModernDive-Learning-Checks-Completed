...
### Practice 3.8.3: Stacked Barplots
...
### Practice 3.8.4: Dodged Barplots
...
### Practice 3.8.5: Faceted Barplots
...
### Practice 4.1: The pipe operator: ` %>% `
...
### Practice 4.3: `summarize` variables
...
### Practice 4.4.1: Grouping by more than one variable
...
### Learning Check 4.5
*Recall from Chapter 3 when we looked at plots of temperatures by months in NYC. What does the standard deviation column in the `sum_monthly_temp` data frame tell us about temperatures in New York City throughout the year?*
...
### Practice 4.5: `mutate` existing variables
...
### Practice 4.6: `arrange` and sort rows
...
### Practice 4.7.1: Matching "key" variable names
...
### Practice 4.7.2: Different "key" variable names
...
### Practice 4.7.3: Multiple "key" variables
...
### Learning Check 4.13
*Looking at Figure 4.7, when joining `flights` and `weather` (or, in other words, matching the hourly weather values with each flight), why do we need to join by all of `year`, `month`, `day`, `hour`, and `origin`, and not just `hour`?*
...
### Practice 4.8.1: `select` variables
...
### Practice 4.8.2: `rename` variables
...
### Practice 4.8.3: `top_n` values of a variable
